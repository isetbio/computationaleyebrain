...
%   simplifies interfaces and make it compatible with cone structure
%   Maybe could we merge it back to isetbio someday?
%
...
% Set information to cone structure
cone.adaptVolts  = adaptedData;  % Millivolts, both positive and negative
cone.adaptGain   = gain;         % Sometimes a number, sometimes a vector
cone.adaptOffset = offset;       % How we set the mean to 0
