...
[os, ct, mp, cdi] = ndgrid(os, ct, mp, cdi);      % create grid
os = os(:); ct = ct(:); mp = mp(:); cdi = cdi(:); % convert to column array
...
simParams = struct(...
    ...
    'nTestLevels',     sParams.nTestLevels, ...
    ...
    'secondSiteFanoFactor', tParams.secondSiteFanoFactor, ...
