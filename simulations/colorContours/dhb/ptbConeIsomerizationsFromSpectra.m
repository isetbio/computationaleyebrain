...
%
% 8/4/13  dhb  Wrote it.
% 6/23/14 dhb  Someone changed the name of this to ptbConeIsomerizationsFromRadiance and put in
%              the error message to alert us (good).  But didn't add a history comment here (bad).
%              It might have been me, but I don't think so.
%
% DHB/BW ISETBIO Team, 2013

%% This routine has been renamed.  Prevent old calling form.
% Sometime soon, the rest of the code should be deleted.  
